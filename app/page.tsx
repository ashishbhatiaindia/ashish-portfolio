...
import { 
  ...
  Zap, Database, Cpu, Server, Shield, Code, Users, Layers, Layout, Trophy
} from 'lucide-react';
...
export default function Portfolio() {
  ...
  const skills = {
    "Languages": ["Java", "SQL"],
    "Backend Architecture": ["Spring Boot", "Microservices Design", "REST APIs", "GraphQL", "SOAP", "Event-Driven Architecture", "System Design", "Design Patterns", "SOLID Principles", "Domain-Driven Design"],
    "Cloud & Containers": ["Google Cloud Platform", "Compute Engine", "Cloud Run", "Cloud Functions", "GKE", "Kubernetes", "Docker", "Vertex AI"],
    "Messaging & Streaming": ["Kafka", "RabbitMQ"],
    "Databases": ["MySQL", "PostgreSQL (RDBMS)", "MongoDB", "Redis", "Elasticsearch (NoSQL)", "pgvector"],
    "AI & Agentic Systems": ["RAG Pipelines", "LangChain", "LangGraph", "Multi-Agent Orchestration", "MCP-Integrated Tools", "Prompt Engineering", "LangSmith", "Claude", "Cursor", "GitHub Copilot"],
    ...
    "Performance & Scalability": ["Caching Strategy", "Query Optimization", "Async Messaging", "Connection Management", "Retry Logic", "Circuit Breakers", "Dead-Letter Queues"],
    "Leadership & Practices": ["Technical Mentoring", "Architecture Reviews", "Engineering Standards", "Cross-Team Technical Direction", "Agile/Scrum", "Code Review"]
  };
