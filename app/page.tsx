      ...
      <section className="relative pt-24 pb-16 px-6 max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="flex flex-wrap gap-y-4 gap-x-8 text-slate-400 font-medium border-b border-slate-800 pb-12">
            ...
            <a href="https://linkedin.com/in/ashishbhatia" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors"><LucideLinkedin size={18}/> LinkedIn</a>
          </div>

          <p className="mt-12 max-w-4xl text-xl text-slate-300">
            Senior software engineer with 9+ years of experience designing and building scalable distributed systems. Expert in microservices, system design, and delivering high-impact solutions for enterprise-scale applications.
          </p>
        </motion.div>
      </section>
        ...
        <div className="space-y-20">
          <ExperienceBlock 
            ...
            bullets={[
              ...
              "Establishing design patterns and best practices across the engineering organization.",
          ...
          <ExperienceBlock 
            ...
            bullets={[
              "Managed a team of engineers, leading sprint planning and technical roadmaps.",
              "Designed Redis caching strategy, improving API response times by 60%.",
          ...
          <ExperienceBlock 
            ...
            bullets={[
              ...
              "Optimized database queries, reducing load by 35% and improving stability.",
              "Designed fault-tolerant integration layers ensuring 99.9% uptime compliance.",
          ...
          <ExperienceBlock 
            ...
            bullets={[
              "Developed core robotics features using Java and Spring Boot.",
